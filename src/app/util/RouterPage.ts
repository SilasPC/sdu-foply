...
/**
 * SOURCE: https://github.com/ionic-team/ionic-framework/issues/15260
 * 
 * Work around for IonViewWillEnter not triggering properly in tabs
 * 
 * @author Joost van Doremalen / commenter 'doender'
 */
